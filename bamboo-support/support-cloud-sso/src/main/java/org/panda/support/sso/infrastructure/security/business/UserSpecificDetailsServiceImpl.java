package org.panda.support.sso.infrastructure.security.business;
...
//        SysUser sysUser = sysUserDto.getUser();
        ...
        userSpecificDetails.setCaption("test");
        // 从数据库中直接取加密密码
//        String encodedPassword = sysUser.getPassword();
        userSpecificDetails.setPassword("123456");
        userSpecificDetails.setIdentity(new DefaultUserIdentity("111", 100));
        ...
        grantedAuthority.setType("type");
        grantedAuthority.setRank("11");
        grantedAuthority.setApp(Strings.ASTERISK); // 通配符'*'
//        grantedAuthority.setPermissions("");
