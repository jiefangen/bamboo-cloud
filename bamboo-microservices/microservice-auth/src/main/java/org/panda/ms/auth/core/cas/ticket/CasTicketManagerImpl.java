package org.panda.ms.auth.core.cas.ticket;

import org.jasig.cas.client.validation.Assertion;
import org.panda.bamboo.common.constant.basic.Strings;
import org.panda.bamboo.common.exception.business.BusinessException;
import org.panda.bamboo.common.util.EncryptUtil;
import org.panda.ms.auth.core.cas.authentication.CasServerScopeResolver;
import org.panda.ms.auth.core.cas.entity.AppTicket;
import org.panda.ms.auth.core.cas.entity.TicketGrantingTicket;
import org.panda.ms.auth.core.cas.repo.AppTicketRepo;
import org.panda.ms.auth.core.cas.repo.MemoryAppTicketRepo;
import org.panda.ms.auth.core.cas.repo.MemoryTicketGrantingTicketRepo;
import org.panda.ms.auth.core.cas.repo.TicketGrantingTicketRepo;
import org.panda.ms.auth.core.cas.service.CasServerExceptionCodes;
import org.panda.ms.auth.core.cas.ticket.validation.SimpleAssertion;
import org.panda.tech.core.web.annotation.WriteTransactional;
...
public class CasTicketManagerImpl implements CasTicketManager {
    ...
    public void createTicketGrantingTicket(HttpServletRequest request, HttpServletResponse response) {
        ...
        // 按照CAS规范将TGT写入Cookie
        WebHttpUtil.setSessionCookie(request, response, CasConstants.COOKIE_TGT, ticketGrantingTicketId);
    ...
    private String readTicketGrantingTicketId(HttpServletRequest request) {
        ...
        if (ticketGrantingTicketId == null) {
            ticketGrantingTicketId = WebHttpUtil.getCookieValue(request, CasConstants.COOKIE_TGT);
        }
    ...
    public List<AppTicket> deleteTicketGrantingTicket(HttpServletRequest request, HttpServletResponse response) {
        ...
        if (ticketGrantingTicket != null) {
            ...
            WebHttpUtil.removeCookie(request, response, CasConstants.COOKIE_TGT);
            return appTickets;
        }
        return Collections.emptyList();
    }
