 ...
 * Redis静态访问模版
 */
public class RedisStaticTemplate {

    private static final RedisTemplate<String, ?> redisTemplate;
    ...
    public static <V> ValueOperations<String, V> ops() {
     ...
     * @param <V> 值类型
     */
    public static <V> void set(String key, V value, Integer seconds) {
     ...
     * @param maps 新增集合
     */
    public static <V> void multiSet(Map<String, V> maps) {
        ops().multiSet(maps);
    }
     ...
     * @return 之前已经存在返回false, 不存在返回true
     */
    public static <V> Boolean multiSetIfAbsent(Map<String, V> maps) {
     ...
     * @return V
     */
    public static <K, V> V hGet(String key, String field) {
     ...
     * @return List<V>
     */
    public static <K,V> List<V> hMultiGet(String key, Collection<K> fields) {
        HashOperations<String, K, V> opeForHash = redisTemplate.opsForHash();
        return opeForHash.multiGet(key, fields);
    }

    public static <K,V> void hPut(String key, K hashKey, V value) {
        HashOperations<String, K, V> hashOperations = redisTemplate.opsForHash();
        hashOperations.put(key, hashKey, value);
    }

    public static <K,V> void hPutAll(String key, Map<K, V> maps) {
        HashOperations<String, K, V> hashOperations = redisTemplate.opsForHash();
     ...
     * @return Boolean
     */
    public static <K,V> Boolean hPutIfAbsent(String key, K hashKey, V value) {
        HashOperations<String, K, V> hashOperations = redisTemplate.opsForHash();
     ...
     * @return Long
     */
    public static <K,V> Long hDelete(String key, K... fields) {
        HashOperations<String, K, V> hashOperations = redisTemplate.opsForHash();
     ...
     * @return boolean
     */
    public static <K,V> boolean hExists(String key, K field) {
        HashOperations<String, K, V> hashOperations = redisTemplate.opsForHash();
     ...
     */
    public static <K,V> Long hIncrBy(String key, K field, long increment) {
        HashOperations<String, K, V> hashOperations = redisTemplate.opsForHash();
     ...
     * 为哈希表 key 中的指定字段的整数值加上增量 increment
     */
    public static <K,V> Double hIncrByFloat(String key, K field, double delta) {
        HashOperations<String, K, V> hashOperations = redisTemplate.opsForHash();
     ...
     * 获取所有哈希表中的字段
     */
    public static <K,V> Set<K> hKeys(String key) {
        HashOperations<String, K, V> hashOperations = redisTemplate.opsForHash();
     ...
     * 获取哈希表中所有值
     */
    public static <K,V> List<V> hValues(String key) {
        HashOperations<String, K, V> hashOperations = redisTemplate.opsForHash();
     ...
     * 迭代哈希表中的键值对
     */
    public static <K,V> Cursor<Map.Entry<K, V>> hScan(String key, ScanOptions options) {
        HashOperations<String, K, V> hashOperations = redisTemplate.opsForHash();
    ...
    public static <V> Long lLeftPushAll(String key, V... value) {
        ListOperations<String,V> listOperations = (ListOperations<String, V>) redisTemplate.opsForList();
        return listOperations.leftPushAll(key, value);
    }

    public static <V> Long lLeftPushAll(String key, Collection<V> value) {
        ListOperations<String,V> listOperations = (ListOperations<String, V>) redisTemplate.opsForList();
        return listOperations.leftPushAll(key, value);
    }
    ...
    public static <V> Long lRightPushAll(String key, V... value) {
        ListOperations<String,V> listOperations = (ListOperations<String, V>) redisTemplate.opsForList();
        return listOperations.rightPushAll(key, value);
    }

    public static <V> Long lRightPushAll(String key, Collection<V> value) {
        ListOperations<String,V> listOperations = (ListOperations<String, V>) redisTemplate.opsForList();
        return listOperations.rightPushAll(key, value);
    }
     ...
     * @param unit 单位
     */
    public static <V> V lBRightPopAndLeftPush(String sourceKey, String destinationKey, long timeout, TimeUnit unit) {
        ListOperations<String,V> listOperations = (ListOperations<String, V>) redisTemplate.opsForList();
        return listOperations.rightPopAndLeftPush(sourceKey,
     ...
     * @param value 值
     */
    public static <V> Long lRemove(String key, long index, V value) {
        ListOperations<String,V> listOperations = (ListOperations<String, V>) redisTemplate.opsForList();
     ...
     * @param values 值集合
     */
    public static <V> Long sRemove(String key, V... values) {
        SetOperations<String,V> setOperations = (SetOperations<String, V>) redisTemplate.opsForSet();
     ...
     * @param value 值
     */
    public static <V> Boolean sIsMember(String key, V value) {
        SetOperations<String,V> setOperations = (SetOperations<String, V>) redisTemplate.opsForSet();
     ...
     */
    public static <V> Set<V> sIntersect(String key, Collection<String> otherKeys) {
        SetOperations<String,V> setOperations = (SetOperations<String, V>) redisTemplate.opsForSet();
     ...
     * 获取两个集合的并集
     */
    public static <V> Set<V> sUnion(String key, String otherKeys) {
        SetOperations<String,V> setOperations = (SetOperations<String, V>) redisTemplate.opsForSet();
     ...
     * 获取key集合与多个集合的并集
     */
    public static <V> Set<V> sUnion(String key, Collection<String> otherKeys) {
        SetOperations<String,V> setOperations = (SetOperations<String, V>) redisTemplate.opsForSet();
        return setOperations.union(key, otherKeys);
    }
     ...
     * 获取key集合与多个集合的差集
     */
    public static <V> Set<V> sDifference(String key, Collection<String> otherKeys) {
        SetOperations<String,V> setOperations = (SetOperations<String, V>) redisTemplate.opsForSet();
     ...
     * 获取集合所有元素
     */
    public static <V> Set<V> sMembers(String key) {
        SetOperations<String,V> setOperations = (SetOperations<String, V>) redisTemplate.opsForSet();
    ...
    public static <V> Long zAdd(String key, Set<ZSetOperations.TypedTuple<V>> values) {
        ZSetOperations<String,V> zSetOperations = (ZSetOperations<String, V>) redisTemplate.opsForZSet();
        return zSetOperations.add(key, values);
    }

    public static <V> Long zRemove(String key, V... values) {
        ZSetOperations<String,V> zSetOperations = (ZSetOperations<String, V>) redisTemplate.opsForZSet();
     ...
     * @return 0表示第一位
     */
    public static <V> Long zRank(String key, V value) {
        ZSetOperations<String,V> zSetOperations = (ZSetOperations<String, V>) redisTemplate.opsForZSet();
     ...
     */
    public static <V> Long zReverseRank(String key, V value) {
        ZSetOperations<String,V> zSetOperations = (ZSetOperations<String, V>) redisTemplate.opsForZSet();
     ...
     * @param end 结束位置
     */
    public static <V> Set<ZSetOperations.TypedTuple<V>> zRangeWithScores(String key, long start, long end) {
        ZSetOperations<String,V> zSetOperations = (ZSetOperations<String, V>) redisTemplate.opsForZSet();
     ...
     * @param max 最大值
     */
    public static <V> Set<ZSetOperations.TypedTuple<V>> zRangeByScoreWithScores(String key,
                                                                         double min, double max) {
        ZSetOperations<String,V> zSetOperations = (ZSetOperations<String, V>) redisTemplate.opsForZSet();
        return zSetOperations.rangeByScoreWithScores(key, min, max);
    }

    public static <V> Set<ZSetOperations.TypedTuple<V>> zRangeByScoreWithScores(String key, double min, double max, long start,
                                                                         long end) {
        ZSetOperations<String,V> zSetOperations = (ZSetOperations<String, V>) redisTemplate.opsForZSet();
        return zSetOperations.rangeByScoreWithScores(key, min, max,
                start, end);
     ...
     */
    public static <V> Set<ZSetOperations.TypedTuple<V>> zReverseRangeWithScores(String key, long start, long end) {
        ZSetOperations<String,V> zSetOperations = (ZSetOperations<String, V>) redisTemplate.opsForZSet();
     ...
     * 根据Score值查询集合元素, 从大到小排序
     */
    public static <V> Set<ZSetOperations.TypedTuple<V>> zReverseRangeByScoreWithScores(String key, double min, double max) {
        ZSetOperations<String,V> zSetOperations = (ZSetOperations<String, V>) redisTemplate.opsForZSet();
        return zSetOperations.reverseRangeByScoreWithScores(key, min, max);
    }

    public static <V>  Set<V> zReverseRangeByScore(String key, double min, double max, long start, long end) {
        ZSetOperations<String,V> zSetOperations = (ZSetOperations<String, V>) redisTemplate.opsForZSet();
     ...
     * 获取集合中value元素的score值
     */
    public static <V> Double zScore(String key, V value) {
        ZSetOperations<String,V> zsetOperations = (ZSetOperations<String, V>) redisTemplate.opsForZSet();
    ...
    public static <V> Cursor<ZSetOperations.TypedTuple<V>> zScan(String key, ScanOptions options) {
        ZSetOperations<String,V> zSetOperations = (ZSetOperations<String, V>) redisTemplate.opsForZSet();
