...
public class RedisStaticTemplate {
    ...
    static {
        ...
        String redisBeanName = "redisTemplate";
        if (applicationContext != null) {
            String beanName = applicationContext.getEnvironment().getProperty("bamboo.redis.init.beanName");
            if (StringUtils.isNotEmpty(beanName)) {
                redisBeanName = beanName;
            }
        }
        redisTemplate = ApplicationContextBean.getBean(redisBeanName);
        if (redisTemplate == null) {
           throw new RuntimeException(redisBeanName + " bean is not configured to load");
        }
    }
     ...
     * @return
     */
    public static <V> V lBRightPopAndLeftPush(String sourceKey, String destinationKey,
     ...
     * @return
     */
    public static <V> Set<ZSetOperations.TypedTuple<V>> zRangeWithScores(String key, long start,
                                                                         long end) {
        ZSetOperations<String,V> zsetOperations = (ZSetOperations<String, V>)redisTemplate.opsForZSet();
     ...
     * @return
     */
    public static <V> Set<ZSetOperations.TypedTuple<V>> zReverseRangeWithScores(String key,
                                                                                long start, long end) {
        ZSetOperations<String,V> zsetOperations = (ZSetOperations<String, V>)redisTemplate.opsForZSet();
     ...
     * @return
     */
    public static <V> Set<V> zReverseRangeByScore(String key, double min,
                                                  double max) {
        ZSetOperations<String,V> zsetOperations = (ZSetOperations<String, V>)redisTemplate.opsForZSet();
     ...
     * @return
     */
    public static <V> Set<ZSetOperations.TypedTuple<V>> zReverseRangeByScoreWithScores(
